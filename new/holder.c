...
void HolderInit(Holder_t* holder, BasePID_Object yaw_angle_pid ,BasePID_Object yaw_speed_pid, BasePID_Object pitch_angle_pid , BasePID_Object pitch_speed_pid, BasePID_Object yaw_reset_pid,BasePID_Object pitch_reset_pid,BasePID_Object yaw1_angle_vision_pid,BasePID_Object yaw1_speed_vision_pid,BasePID_Object pitch_angle_vision_pid,BasePID_Object pitch_speed_vision_pid,CanNumber canx)
{
	...
	BasePID_Init(&holder->Motors6020.turnPID[6], yaw1_angle_vision_pid.Kp, yaw1_angle_vision_pid.Ki, yaw1_angle_vision_pid.Kd, yaw1_angle_vision_pid.KiPartDetachment);
	BasePID_Init(&holder->Motors6020.turnPID[7], yaw1_speed_vision_pid.Kp, yaw1_speed_vision_pid.Ki, yaw1_speed_vision_pid.Kd, yaw1_speed_vision_pid.KiPartDetachment);
	BasePID_Init(&holder->Motors6020.turnPID[8], pitch_angle_vision_pid.Kp, pitch_angle_vision_pid.Ki, pitch_angle_vision_pid.Kd, pitch_angle_vision_pid.KiPartDetachment);
	BasePID_Init(&holder->Motors6020.turnPID[9], pitch_speed_vision_pid.Kp, pitch_speed_vision_pid.Ki, pitch_speed_vision_pid.Kd, pitch_speed_vision_pid.KiPartDetachment);
...
//				}
 ...
 holder->Pitch.Target_Angle =float_constrain(holder->Pitch.Target_Angle,holder->down_litmit,holder->up_litmit);		
	...
	BasePID_YawSpeedControl((BasePID_Object*)(holder->Motors6020.turnPID + 1) , 
	BasePID_YawAngleControl((BasePID_Object*)(holder->Motors6020.turnPID + 0) , holder->Yaw.Target_Angle , holder->Yaw.GYRO_Angle)  ,-holder->Yaw.GYRO_Angle_speed);



	holder->Motors6020.motor[1].Data.Output =
	BasePID_PitchSpeedControl((BasePID_Object*)(holder->Motors6020.turnPID + 3) , 
	BasePID_PitchAngleControl((BasePID_Object*)(holder->Motors6020.turnPID + 2) , holder->Pitch.Target_Angle , holder->Pitch.GYRO_Angle)  ,holder->Pitch.GYRO_Angle_speed);

	holder->Motors6020.motor[2].Data.Output =
	BasePID_YawSpeedControl((BasePID_Object*)(holder->Motors6020.turnPID + 7) ,
	BasePID_YawAngleControl((BasePID_Object*)(holder->Motors6020.turnPID + 6) , holder->Yaw1.Target_Angle , holder->Yaw1.Can_Angle)  ,-holder->Yaw1.GYRO_Angle_speed);
for (int i=0;i<3;i++)
